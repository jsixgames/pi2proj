...
public class TabelaPlataforma extends AbstractTableModel {   
    ...
    private List<Console> valores;         
  
    //Esse é um construtor, que recebe a nossa lista de livros   
    public TabelaPlataforma(List<Console> valores) {
    ...
    public Object getValueAt(int row, int column) {   
        ...
        Console titulo = valores.get(row);   
        if (column == COD_PLAT) 
            return titulo.getId();   
    ...
    public void setValueAt(Console aValue, int rowIndex, int columnIndex) {   
        Console titulo = valores.get(rowIndex);   
