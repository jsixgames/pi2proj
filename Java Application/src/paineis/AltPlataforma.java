 ...
 * @author jeckson
 */
public class AltPlataforma extends JFrame{
    JLabel msgErro;
    JTextField tfPlat;
    JPanel painel;
    JTable tabela;
    int nunFlag = 0;
    public AltPlataforma (){
        ...
        botaoAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                 ...
                 if(tfPlat.getText().isEmpty() || nunFlag == 0){
                     JOptionPane.showMessageDialog(null,"Selecione uma plataforma para ser alterada!");
                 }
                 else {
                     ...
                     try {
                        ...
                        control.edit(con);
                        dispose();
                        JOptionPane.showMessageDialog(null, "Plataforma Alterda com sucesso");
