...
<html>
    ...
    <body>
        ...
        <div id="conteudo">                 
        <% out.println("<h1 id='titulocadastro'>Cadastro realizado com sucesso, bem vindo " + "<span style='color:blue'>"
                +session.getAttribute("user")+"</span>, faça seu login abaixo!</h1>");                       
